function [yopt,fopt,exit]=optim_5(A, flag, xpos,xneg)
...
if(flag(1)==0)
 ...
 function f=fobj(y)  % maximizar el area intermedia
   ...
   f=-pi*(y(1)*y(2)*(1-y(3)*y(3)))+A(1)*abs(y(1)-y(2));
 end
...
title('');
legend('positivos','negativos','Elipse H+','Elipse H-');
